...
public class NoviziatoController implements FXController {
    ...
    @FXML
    void showMembri(MouseEvent event) {
        List<Associato> membri = Associato.DAO.getMembriNoviziato(controller.getConnection(), controller.getModel().getAssociato());
        for (Associato membro : membri) {
